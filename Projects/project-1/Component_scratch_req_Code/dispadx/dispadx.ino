...
{ 
 ...
 //Output in m/sec^2) 
 Serial.print("X: "); Serial.print(event.acceleration.x); Serial.print("run "); 
 Serial.print("Y: "); Serial.print(event.acceleration.y); Serial.print("catch "); 
 Serial.print ("Z: "); Serial.print(event.acceleration.Z); the Serial.print("fight ");Serial.println("m/s^2 "); 
 delay(500); 
} 
